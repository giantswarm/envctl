// Package workflow provides workflow management and execution capabilities for envctl.
//
...
//   - User configuration directory: ~/.config/envctl/workflows/
//   - Project configuration directory: .envctl/workflows/
//
