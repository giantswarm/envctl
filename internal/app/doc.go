// Package app provides the application bootstrap and lifecycle management for envctl.
//
// This package implements a clean separation of concerns for the envctl application:
//
// # Architecture
//
