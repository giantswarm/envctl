...
func TestConfigurationLoader_LayeredLoading(t *testing.T) {
	...
	tempDir := t.TempDir()
	userDir := filepath.Join(tempDir, "user", ".config", "envctl")
	projectDir := filepath.Join(tempDir, "project", ".envctl")
...
func TestGetConfigurationPaths(t *testing.T) {
	...
	expectedUserDir := filepath.Join(tempDir, "home", ".config", "envctl")
	expectedProjectDir := filepath.Join(tempDir, "project", ".envctl")
