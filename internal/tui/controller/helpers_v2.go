...
// GenerateMcpConfigJsonV2 generates MCP configuration JSON for v2
func GenerateMcpConfigJsonV2(mcpServerConfigs []config.MCPServerDefinition, mcpServers map[string]*api.MCPServerInfo) string {
	type entry struct {
		URL         string `json:"url"`
...
// PrepareLogContentV2 is a wrapper around the view function
func PrepareLogContentV2(lines []string, maxWidth int) string {
