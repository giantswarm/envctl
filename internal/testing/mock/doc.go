// Package mock provides mock MCP server functionality for testing envctl components.
//
...
//     Use `envctl test --mock-mcp-server --mock-config=path/to/config.yaml` to
...
// Integration:
//
// This package is designed to work seamlessly with the envctl testing framework
